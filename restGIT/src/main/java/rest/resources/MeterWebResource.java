...
public class MeterWebResource {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces (MediaType.APPLICATION_JSON)	
	public Response setMeter(@PathParam("hostIp") String hostIp, @PathParam("hostPort") String hostPort,  String jsonIn) {
		LogTools.rest("POST", "setMeter", "Body:\n" + jsonIn);
		Response resRest = null;
		OnosResponse response = null;
		String url = "";
	...
	@DELETE
	@Produces (MediaType.APPLICATION_JSON)	
	public Response deleteMeterBySocket(@PathParam("hostIp") String hostIp, @PathParam("hostPort") String hostPort) {
		Response resRest = null;
